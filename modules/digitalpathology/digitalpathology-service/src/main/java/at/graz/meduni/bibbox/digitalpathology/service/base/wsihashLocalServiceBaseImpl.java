...
import at.graz.meduni.bibbox.digitalpathology.service.wsihashLocalService;
...
/**
 * Provides the base implementation for the wsihash local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.bibbox.digitalpathology.service.impl.wsihashLocalServiceImpl}.
 * </p>
 *
 * @author robert
 ...
 */
@ProviderType
public abstract class wsihashLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements wsihashLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.bibbox.digitalpathology.service.wsihashLocalServiceUtil} to access the wsihash local service.
	 */
	...
	public wsihash addwsihash(wsihash wsihash) {
		...
		return wsihashPersistence.update(wsihash);
	}
	...
	public wsihash createwsihash(long wsihashId) {
		return wsihashPersistence.create(wsihashId);
	}
	...
	public wsihash deletewsihash(long wsihashId) throws PortalException {
		return wsihashPersistence.remove(wsihashId);
	}
	...
	public wsihash deletewsihash(wsihash wsihash) {
		return wsihashPersistence.remove(wsihash);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(wsihash.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return wsihashPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return wsihashPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return wsihashPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return wsihashPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return wsihashPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public wsihash fetchwsihash(long wsihashId) {
		return wsihashPersistence.fetchByPrimaryKey(wsihashId);
	}
	 ...
	 */
	@Override
	public wsihash fetchwsihashByUuidAndGroupId(String uuid, long groupId) {
		return wsihashPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public wsihash getwsihash(long wsihashId) throws PortalException {
		return wsihashPersistence.findByPrimaryKey(wsihashId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(wsihashLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(wsihash.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("wsihashId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(wsihashLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(wsihash.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("wsihashId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setAddCriteriaMethod(new ActionableDynamicQuery.AddCriteriaMethod() {
				...
				public void addCriteria(DynamicQuery dynamicQuery) {
					...
					if (portletDataContext.isInitialPublication()) {
						...
						StagedModelDataHandler<?> stagedModelDataHandler = StagedModelDataHandlerRegistryUtil.getStagedModelDataHandler(wsihash.class.getName());
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<wsihash>() {
				@Override
				public void performAction(wsihash wsihash)
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(wsihash.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return wsihashLocalService.deletewsihash((wsihash)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return wsihashPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<wsihash> getwsihashsByUuidAndCompanyId(String uuid,
		long companyId) {
		return wsihashPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<wsihash> getwsihashsByUuidAndCompanyId(String uuid,
		...
		return wsihashPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	 ...
	 */
	@Override
	public wsihash getwsihashByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return wsihashPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<wsihash> getwsihashs(int start, int end) {
		return wsihashPersistence.findAll(start, end);
	}
	...
	public int getwsihashsCount() {
		return wsihashPersistence.countAll();
	}
	 ...
	 */
	public wsihashLocalService getwsihashLocalService() {
	 ...
	 */
	public void setwsihashLocalService(wsihashLocalService wsihashLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("at.graz.meduni.bibbox.digitalpathology.model.wsihash",
			wsihashLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"at.graz.meduni.bibbox.digitalpathology.model.wsihash");
	}
	...
	public String getOSGiServiceIdentifier() {
		return wsihashLocalService.class.getName();
	}
	...
	@BeanReference(type = wsihashLocalService.class)
	protected wsihashLocalService wsihashLocalService;
