...
<liferay-ui:search-container total="<%=MedicalRecordLocalServiceUtil.getMedicalRecordsCount()%>">
	<liferay-ui:search-container-results results="<%=MedicalRecordLocalServiceUtil.getEntries(scopeGroupId.longValue(), medicalRecordId, searchContainer.getStart(), searchContainer.getEnd())%>" />	
