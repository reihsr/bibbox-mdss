...
<div class="panel panel-default">
		...
		<%
		List<ImportMedicalDataSetLog> importMedicalDataSetLogs = ImportMedicalDataSetLogLocalServiceUtil.getImportMedicalDataSetFromImportsAtStatusLogs(importMedicalDataSetId, 25);
