...
/**
 * This class is used by SOAP remote services, specifically {@link at.graz.meduni.bibbox.medicaldataset.service.http.PathologieDataServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see at.graz.meduni.bibbox.medicaldataset.service.http.PathologieDataServiceSoap
 * @generated
 */
@ProviderType
public class PathologieDataSoap implements Serializable {
	public static PathologieDataSoap toSoapModel(PathologieData model) {
		PathologieDataSoap soapModel = new PathologieDataSoap();

		soapModel.setUuid(model.getUuid());
		soapModel.setPathologieDataId(model.getPathologieDataId());
	...
	public static PathologieDataSoap[] toSoapModels(PathologieData[] models) {
		PathologieDataSoap[] soapModels = new PathologieDataSoap[models.length];
	...
	public static PathologieDataSoap[][] toSoapModels(PathologieData[][] models) {
		PathologieDataSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new PathologieDataSoap[models.length][models[0].length];
		}
		else {
			soapModels = new PathologieDataSoap[0][0];
		}
	...
	public static PathologieDataSoap[] toSoapModels(List<PathologieData> models) {
		List<PathologieDataSoap> soapModels = new ArrayList<PathologieDataSoap>(models.size());

		for (PathologieData model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new PathologieDataSoap[soapModels.size()]);
	}

	public PathologieDataSoap() {
	}
