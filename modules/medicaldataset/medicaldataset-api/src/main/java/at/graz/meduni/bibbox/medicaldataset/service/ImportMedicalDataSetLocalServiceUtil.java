...
/**
 * Provides the local service utility for ImportMedicalDataSet. This utility wraps
 * {@link at.graz.meduni.bibbox.medicaldataset.service.impl.ImportMedicalDataSetLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class ImportMedicalDataSetLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link at.graz.meduni.bibbox.medicaldataset.service.impl.ImportMedicalDataSetLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet addImportMedicalDataSet(
		...
		return getService().addImportMedicalDataSet(importMedicalDataSet);
	}
	...
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet addImportMedicalDataSet(
		...
		return getService()
			...
			description, fileName, filePath, importStatus, serviceContext);
	}
	...
	*/
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet createImportMedicalDataSet(
		long importMedicalDataSetId) {
		return getService().createImportMedicalDataSet(importMedicalDataSetId);
	}
	...
	*/
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet deleteImportMedicalDataSet(
		at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet importMedicalDataSet) {
		return getService().deleteImportMedicalDataSet(importMedicalDataSet);
	}
	...
	*/
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet deleteImportMedicalDataSet(
		long importMedicalDataSetId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteImportMedicalDataSet(importMedicalDataSetId);
	}

	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet fetchImportMedicalDataSet(
		long importMedicalDataSetId) {
		return getService().fetchImportMedicalDataSet(importMedicalDataSetId);
	}
	...
	*/
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet fetchImportMedicalDataSetByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return getService()
				   .fetchImportMedicalDataSetByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a import medical data set with the primary key could not be found
	*/
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet getImportMedicalDataSet(
		long importMedicalDataSetId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getImportMedicalDataSet(importMedicalDataSetId);
	}
	...
	*/
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet getImportMedicalDataSetByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getImportMedicalDataSetByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet updateImportMedicalDataSet(
		at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet importMedicalDataSet) {
		return getService().updateImportMedicalDataSet(importMedicalDataSet);
	}
	...
	public static at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet updateImportMedicalDataSet(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateImportMedicalDataSet(importMedicalDataSet,
			serviceContext);
	}
	...
	*/
	...
	public static int getImportMedicalDataSetCount(long groupId) {
		return getService().getImportMedicalDataSetCount(groupId);
	}
	...
	*/
	public static int getImportMedicalDataSetsCount() {
		return getService().getImportMedicalDataSetsCount();
	}
	...
	*/
	public static java.util.List<at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet> getImportMedicalDataSets(
		int start, int end) {
		return getService().getImportMedicalDataSets(start, end);
	}

	public static java.util.List<at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet> getImportMedicalDataSets(
		long groupId) {
		return getService().getImportMedicalDataSets(groupId);
	}

	public static java.util.List<at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet> getImportMedicalDataSets(
		long groupId, int start, int end) {
		return getService().getImportMedicalDataSets(groupId, start, end);
	}

	public static java.util.List<at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet> getImportMedicalDataSets(
		long groupId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet> ob) {
		return getService().getImportMedicalDataSets(groupId, start, end, ob);
	}
	...
	*/
	public static java.util.List<at.graz.meduni.bibbox.medicaldataset.model.ImportMedicalDataSet> getImportMedicalDataSetsByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return getService()
				   .getImportMedicalDataSetsByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	...
	public static ImportMedicalDataSetLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<ImportMedicalDataSetLocalService, ImportMedicalDataSetLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ImportMedicalDataSetLocalService.class);
}