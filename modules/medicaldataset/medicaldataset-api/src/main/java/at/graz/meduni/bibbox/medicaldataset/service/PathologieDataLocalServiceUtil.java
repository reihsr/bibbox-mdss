...
public class PathologieDataLocalServiceUtil {
	...
	*/
	...
	public static at.graz.meduni.bibbox.medicaldataset.model.PathologieData addPathologieData(
		...
		return getService()
				   .addPathologieData(medicalRecordId, receivedDate,
	...
	*/
	...
	public static at.graz.meduni.bibbox.medicaldataset.model.PathologieData getPathologieDataForMedicalRecord(
		long medicalRecordId)
		throws at.graz.meduni.bibbox.medicaldataset.exception.NoSuchPathologieDataException {
		return getService().getPathologieDataForMedicalRecord(medicalRecordId);
	}
	...
	*/
	...
	public static at.graz.meduni.bibbox.medicaldataset.model.PathologieData updatePathologieData(
		...
		com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().updatePathologieData(pathologieData, serviceContext);
	}
	...
	public static at.graz.meduni.bibbox.medicaldataset.model.PathologieData updatePathologieData(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updatePathologieData(pathologieDataId, medicalRecordId,
	...
	*/
	...
	public static int getPathologieDataCount(long groupId) {
		return getService().getPathologieDataCount(groupId);
	}
	...
	*/
	...
	public static java.util.List<at.graz.meduni.bibbox.medicaldataset.model.PathologieData> getPathologieDatas(
		long groupId) {
		return getService().getPathologieDatas(groupId);
	}

	public static java.util.List<at.graz.meduni.bibbox.medicaldataset.model.PathologieData> getPathologieDatas(
		long groupId, int start, int end) {
		return getService().getPathologieDatas(groupId, start, end);
	}

	public static java.util.List<at.graz.meduni.bibbox.medicaldataset.model.PathologieData> getPathologieDatas(
		long groupId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<at.graz.meduni.bibbox.medicaldataset.model.PathologieData> ob) {
		return getService().getPathologieDatas(groupId, start, end, ob);
	}
