...
public class KloetzelBuchPersistenceImpl extends BasePersistenceImpl<KloetzelBuch>
	...
	/**
	 * Returns all the kloetzel buchs that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the matching kloetzel buchs that the user has permission to view
	 */
	@Override
	public List<KloetzelBuch> filterFindByGroupId(long groupId) {
		return filterFindByGroupId(groupId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the kloetzel buchs that the user has permission to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link KloetzelBuchModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 * @param start the lower bound of the range of kloetzel buchs
	 * @param end the upper bound of the range of kloetzel buchs (not inclusive)
	 * @return the range of matching kloetzel buchs that the user has permission to view
	 */
	@Override
	public List<KloetzelBuch> filterFindByGroupId(long groupId, int start,
		int end) {
		return filterFindByGroupId(groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the kloetzel buchs that the user has permissions to view where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link KloetzelBuchModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 * @param end the upper bound of the range of kloetzel buchs (not inclusive)
	 * @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	 * @return the ordered range of matching kloetzel buchs that the user has permission to view
	 */
	@Override
	public List<KloetzelBuch> filterFindByGroupId(long groupId, int start,
		...
		if (getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_KLOETZELBUCH_WHERE);
		}
		else {
			query.append(_FILTER_SQL_SELECT_KLOETZELBUCH_NO_INLINE_DISTINCT_WHERE_1);
		}

		query.append(_FINDER_COLUMN_GROUPID_GROUPID_2);

		if (!getDB().isSupportsInlineDistinct()) {
			query.append(_FILTER_SQL_SELECT_KLOETZELBUCH_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(KloetzelBuchModelImpl.ORDER_BY_SQL);
			}
		}
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				q.addEntity(_FILTER_ENTITY_ALIAS, KloetzelBuchImpl.class);
			}
			else {
				q.addEntity(_FILTER_ENTITY_TABLE, KloetzelBuchImpl.class);
			}
			...
			return (List<KloetzelBuch>)QueryUtil.list(q, getDialect(), start,
				end);
		}
		catch (Exception e) {
			throw processException(e);
	...
	/**
	 * Returns the kloetzel buchs before and after the current kloetzel buch in the ordered set of kloetzel buchs that the user has permission to view where groupId = &#63;.
	 *
	 * @param kloetzelBuchId the primary key of the current kloetzel buch
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public KloetzelBuch[] filterFindByGroupId_PrevAndNext(long kloetzelBuchId,
		long groupId, OrderByComparator<KloetzelBuch> orderByComparator)
		throws NoSuchKloetzelBuchException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByGroupId_PrevAndNext(kloetzelBuchId, groupId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByGroupId_PrevAndNext(session, kloetzelBuch,
					groupId, orderByComparator, true);

			array[1] = kloetzelBuch;

			array[2] = filterGetByGroupId_PrevAndNext(session, kloetzelBuch,
	...
	protected KloetzelBuch filterGetByGroupId_PrevAndNext(Session session,
		KloetzelBuch kloetzelBuch, long groupId,
		OrderByComparator<KloetzelBuch> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns the number of kloetzel buchs that the user has permission to view where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the number of matching kloetzel buchs that the user has permission to view
	 */
	@Override
	public int filterCountByGroupId(long groupId) {
		...
		query.append(_FILTER_SQL_COUNT_KLOETZELBUCH_WHERE);
