...
public class ImportMedicalDataSetLogPersistenceImpl extends BasePersistenceImpl<ImportMedicalDataSetLog>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_IMPORTMEDICALDATASET =
		new FinderPath(ImportMedicalDataSetLogModelImpl.ENTITY_CACHE_ENABLED,
			...
			ImportMedicalDataSetLogModelImpl.IMPORTMEDICALDATASETID_COLUMN_BITMASK |
			ImportMedicalDataSetLogModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_IMPORTMEDICALDATASET = new FinderPath(ImportMedicalDataSetLogModelImpl.ENTITY_CACHE_ENABLED,
			ImportMedicalDataSetLogModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	@Override
	public List<ImportMedicalDataSetLog> findByImportMedicalDataSet(
	 ...
	 */
	@Override
	public ImportMedicalDataSetLog findByImportMedicalDataSet_First(
		long importMedicalDataSetId,
		OrderByComparator<ImportMedicalDataSetLog> orderByComparator)
		throws NoSuchImportMedicalDataSetLogException {
		ImportMedicalDataSetLog importMedicalDataSetLog = fetchByImportMedicalDataSet_First(importMedicalDataSetId,
				orderByComparator);
	 ...
	 */
	@Override
	public ImportMedicalDataSetLog fetchByImportMedicalDataSet_First(
		long importMedicalDataSetId,
		OrderByComparator<ImportMedicalDataSetLog> orderByComparator) {
		List<ImportMedicalDataSetLog> list = findByImportMedicalDataSet(importMedicalDataSetId,
	 ...
	 */
	@Override
	public ImportMedicalDataSetLog findByImportMedicalDataSet_Last(
		long importMedicalDataSetId,
		OrderByComparator<ImportMedicalDataSetLog> orderByComparator)
		throws NoSuchImportMedicalDataSetLogException {
		ImportMedicalDataSetLog importMedicalDataSetLog = fetchByImportMedicalDataSet_Last(importMedicalDataSetId,
				orderByComparator);
	 ...
	 */
	@Override
	public ImportMedicalDataSetLog fetchByImportMedicalDataSet_Last(
		long importMedicalDataSetId,
		OrderByComparator<ImportMedicalDataSetLog> orderByComparator) {
	 ...
	 */
	@Override
	public ImportMedicalDataSetLog[] findByImportMedicalDataSet_PrevAndNext(
		long importMedicalDataSetLogId, long importMedicalDataSetId,
		OrderByComparator<ImportMedicalDataSetLog> orderByComparator)
		throws NoSuchImportMedicalDataSetLogException {
		ImportMedicalDataSetLog importMedicalDataSetLog = findByPrimaryKey(importMedicalDataSetLogId);
	...
	protected ImportMedicalDataSetLog getByImportMedicalDataSet_PrevAndNext(
		Session session, ImportMedicalDataSetLog importMedicalDataSetLog,
		long importMedicalDataSetId,
		OrderByComparator<ImportMedicalDataSetLog> orderByComparator,
		boolean previous) {
	...
	public void removeByImportMedicalDataSet(long importMedicalDataSetId) {
		for (ImportMedicalDataSetLog importMedicalDataSetLog : findByImportMedicalDataSet(
