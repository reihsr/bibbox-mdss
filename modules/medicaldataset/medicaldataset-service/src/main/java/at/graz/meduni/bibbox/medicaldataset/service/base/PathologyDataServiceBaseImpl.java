...
import at.graz.meduni.bibbox.medicaldataset.service.PathologyDataService;
...
/**
 * Provides the base implementation for the pathology data remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link at.graz.meduni.bibbox.medicaldataset.service.impl.PathologyDataServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PathologyDataServiceBaseImpl extends BaseServiceImpl
	implements PathologyDataService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link at.graz.meduni.bibbox.medicaldataset.service.PathologyDataServiceUtil} to access the pathology data remote service.
	 */
	 ...
	 */
	public PathologyDataService getPathologyDataService() {
	...
	public String getOSGiServiceIdentifier() {
		return PathologyDataService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = pathologyDataPersistence.getDataSource();
	...
	@BeanReference(type = PathologyDataService.class)
	protected PathologyDataService pathologyDataService;
