...
create index IX_DD9625E on medicaldataset_ImportMedicalDataSet (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_9872E860 on medicaldataset_ImportMedicalDataSet (uuid_[$COLUMN_LENGTH:75$], groupId);
...
create index IX_F5FB2F80 on medicaldataset_ImportMedicalDataSetFieldMap (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_EB899602 on medicaldataset_ImportMedicalDataSetFieldMap (uuid_[$COLUMN_LENGTH:75$], groupId);
...
create index IX_D4EEACBA on medicaldataset_ImportMedicalDataSetLog (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_45CF19BC on medicaldataset_ImportMedicalDataSetLog (uuid_[$COLUMN_LENGTH:75$], groupId);
...
create index IX_97237A0E on medicaldataset_KloetzelBuch (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_C3BF2C10 on medicaldataset_KloetzelBuch (uuid_[$COLUMN_LENGTH:75$], groupId);
...
create index IX_C27647E4 on medicaldataset_MedicalRecord (uuid_[$COLUMN_LENGTH:75$], companyId);
